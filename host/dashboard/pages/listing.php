    ...
    <header class="navbar">
      <nav class="navbar-container">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item">
            <a href="calendar_router.php" class="nav-link">
              Kalender
            </a>
          </li>
          <li class="nav-item">
    ...
    <main class="main-content">
      <section class="content-header">
        ...
        <div class="header-buttons">
          ...
          <a
            href="../../../host/onboarding/pages/about_place.html"
            class="header-button"
      ...
      <section class="list-section list-view">
        <table>
          ...
          <tbody>
            <tr
              class="listing-row"
              data-href="../../../host/onboarding/pages/about_place.html">
              <td>
                <div class="listing-cell">
                  <img
                    ...
                    alt="" />
                  <h3 class="listing-name">Villa Sunset Tepi Pantai</h3>
                </div>
              </td>
              <td>Hotel</td>
              <td>Kecamatan Blimbing, Indonesia</td>
              <td>
              ...
              <td>
                <div class="listing-cell">
                  <img
                    ...
                    class="listing-thumbnail"
                    alt="" />
                  <h3 class="listing-name">Rumah Kayu Jawa</h3>
                </div>
              </td>
              <td>Homestay</td>
              <td>Kecamatan Blimbing, Indonesia</td>
              ...
              <td>
                <div class="listing-cell">
                  ...
                  <h3 class="listing-name">
                    Apartment listing dimulai 2 Mei 2026
                  </h3>
                </div>
              </td>
              <td>Apartemen</td>
      ...
      <section class="list-section grid-view" style="display: none">
        <a href="../../../host/onboarding/pages/about_place.html" class="listing-card">
