  ...
  <header class="navbar">
    <nav class="navbar-container">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item"><a href="/teman_singgah/user/pages/about_us.php" class="nav-link active">Tentang Kami</a>
        </li>
    ...
    <section class="story-section">
      <div class="story-container">
        <div class="story-content">
          ...
          <p class="story-text">
            Teman Singgah lahir dari ketertarikan kami terhadap dunia hospitality dan bagaimana teknologi bisa
            mempertemukan traveler dengan penginapan lokal yang autentik. Platform ini kami rancang untuk mensimulasikan
            pengalaman memesan penginapan dari pencarian properti, pemilihan tanggal, hingga proses reservasi.
          </p>
          <p class="story-text">
            Dibangun pada 2025 sebagai bagian dari proyek sekolah, proyek ini jadi ruang bagi kami untuk belajar
            merancang produk digital dari nol. Kami ingin Teman Singgah jadi bukti bahwa ide sederhana pun bisa
      ...
      <div class="values-container">
        ...
        <div class="values-grid">
          <div class="value-card">
            ...
            <p>Kami percaya keramahan terbaik datang dari yang paling dekat. Setiap host membawa karakter dan budaya
              daerahnya masing-masing.</p>
          </div>
          <div class="value-card">
            <div class="value-icon"><i class="ph-bold ph-shield-check"></i></div>
            <h3>Keamanan Terjamin</h3>
            <p>Kenyamanan tamu dan host adalah prioritas kami. Didukung proses verifikasi yang teliti dan layanan
              bantuan yang siap kapan saja.</p>
          </div>
          <div class="value-card">
    ...
    <section class="invite-section">
      <div class="invite-container">
        <div class="invite-text">
          ...
          <p>Baik sebagai tamu mencari penginapan atau host membuka pintu, Teman Singgah adalah rumah bagi semua yang
            percaya pada kehangatan Indonesia.</p>
        </div>
