<?php
session_start();
require_once '../../auth/guard_user.php';
...
/* ── FIX: query reviews langsung dari user_id di tabel reviews ── */
$stmt = mysqli_prepare($koneksi, "
    SELECT r.*,
           u.nama   AS user_nama,
      ...
      <div class="info-body">
        <div class="info-meta">
          <div class="info-rating">
            ...
            $empty = 5 - $full - $half;
            for ($i = 0; $i < $full;  $i++) echo '<i class="ph-fill ph-star"></i>';
            if ($half)                         echo '<i class="ph-fill ph-star-half"></i>';
            for ($i = 0; $i < $empty; $i++) echo '<i class="ph-bold ph-star"></i>';
            ?>
          </div>
        ...
        <section class="policy-section">
          ...
          <div class="policy-grid">
            <div class="policy-item">
              ...
              <div class="policy-text"><strong>Check-in</strong><span>Dari 14:00 WIB</span></div>
            </div>
            <div class="policy-item">
              <span class="policy-icon"><i class="ph-bold ph-clock"></i></span>
              <div class="policy-text"><strong>Check-out</strong><span>Sebelum 12:00 WIB</span></div>
            </div>
            <div class="policy-item">
              <span class="policy-icon"><i class="ph-bold ph-prohibit"></i></span>
              <div class="policy-text"><strong>Pembatalan</strong><span>Gratis hingga 24 jam sebelum check-in</span></div>
            </div>
            <div class="policy-item">
              <span class="policy-icon"><i class="ph-bold ph-paw-print"></i></span>
              <div class="policy-text"><strong>Hewan Peliharaan</strong><span>Tidak diperbolehkan</span></div>
            </div>
            <div class="policy-item">
              <span class="policy-icon"><i class="ph-bold ph-cigarette-slash"></i></span>
              <div class="policy-text"><strong>Merokok</strong><span>Dilarang di semua area dalam ruangan</span></div>
            </div>
            <div class="policy-item">
              <span class="policy-icon"><i class="ph-bold ph-baby"></i></span>
              <div class="policy-text"><strong>Anak-anak</strong><span>Selamat datang, kasur tambahan tersedia</span></div>
            </div>
          </div>
        </section>
        ...
        <form id="reviewForm" class="review-form">
          ...
          <div class="review-field">
            ...
            <textarea id="reviewComment" name="komentar" class="review-textarea"
              placeholder="Ceritakan pengalamanmu menginap di sini..."
