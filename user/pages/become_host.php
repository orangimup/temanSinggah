...
<body>
  <header class="navbar">
    <nav class="navbar-container">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item"><a href="/teman_singgah/user/pages/become_host.php" class="nav-link active">Jadi Host</a>
        </li>
  ...
  <main>
      ...
      <div class="hero-container">
        ...
        <div class="hero-buttons">
          <a href="/teman_singgah/host/onboarding/pages/about_place.html">
            <button class="hero-button primary-button"><i class="ph-bold ph-plus-circle"></i> Daftarkan
              Properti</button>
          </a>
    ...
    <section class="benefits-section" id="benefitSection">
      <div class="benefits-container">
        ...
        <div class="benefits-body">
          ...
          <p class="section-description">Kami hadir sebagai mitra, bukan sekadar platform. Setiap fitur dirancang untuk
            membuat perjalananmu sebagai host semudah mungkin.</p>
          <div class="benefits-list">
            <div class="benefit-item">
              <div class="benefit-icon"><i class="ph-bold ph-wallet"></i></div>
              <div class="benefit-text">
                <h3>Penghasilan Tambahan yang Nyata</h3>
                <p>Host rata-rata mendapatkan Rp 5–15 juta per bulan tergantung tipe properti dan lokasi. Pembayaran
                  langsung ke rekeningmu setiap minggu.</p>
              </div>
            </div>
            <div class="benefit-item">
              ...
              <div class="benefit-text">
                ...
                <p>Atur sendiri harga, ketersediaan, dan aturan tamu. Tidak ada kewajiban minimum. Buka tutup kapan pun
                  kamu mau.</p>
              </div>
            </div>
            <div class="benefit-item">
              ...
              <div class="benefit-text">
                ...
                <p>Setiap pemesanan dilindungi oleh Jaminan Host kami hingga Rp 50 juta. Tamu juga telah terverifikasi
                  sebelum bisa memesan.</p>
              </div>
            </div>
            <div class="benefit-item">
              ...
              <div class="benefit-text">
                ...
                <p>Tim kami siap membantu kamu kapan pun melalui chat, telepon, atau email. Kamu tidak pernah sendirian
                  sebagai host.</p>
              </div>
            </div>
          </div>
    ...
    <section class="guide-section">
      <div class="guide-container">
        <div class="guide-header">
          ...
          <p class="section-description guide">Tidak perlu keahlian teknis. Proses pendaftaran bisa diselesaikan dalam
            kurang dari 15 menit.</p>
        </div>
        <div class="guide-steps">
          <div class="step-card">
            <div class="step-number">1</div>
            <h3>Daftarkan Propertimu</h3>
            <p>Isi detail properti, unggah foto, dan tentukan harga. Panduan langkah demi langkah tersedia di setiap
              bagian.</p>
          </div>
          <div class="step-card">
          ...
          <div class="step-card">
            ...
            <p>Setelah tamu check-out, pembayaran otomatis dikirim ke rekeningmu. Pantau pendapatan lewat dashboard
              host.</p>
          </div>
        </div>
      </div>
      ...
      <div class="testi-container">
        ...
        <div class="testi-grid">
          <div class="testi-card">
            ...
            <p class="testi-quote">Awalnya ragu, tapi ternyata prosesnya sangat mudah. Sekarang villa saya di Ubud
              terisi hampir setiap akhir pekan.</p>
          ...
          <div class="testi-card">
            ...
            <p class="testi-quote">Saya punya 2 kamar kosong di rumah. Dengan Teman Singgah, dua-duanya terisi hampir
              penuh setiap bulan.</p>
            <div class="testi-author">
          ...
          <div class="testi-card">
            ...
            <p class="testi-quote">Yang paling saya suka adalah fleksibilitasnya. Kalau keluarga mau menginap, tinggal
              blokir tanggalnya.</p>
            <div class="testi-author">
    ...
    <section class="faq-section">
      ...
      <div class="faq-list">
        <div class="faq-item">
          <button class="faq-question"><span>Apakah properti saya harus berbintang atau berlisensi?</span>
            <div class="faq-icon"><i class="ph-bold ph-plus"></i></div>
          </button>
          <div class="faq-answer">
            <p>Tidak perlu. Properti apapun bisa didaftarkan selama kondisinya layak huni, bersih, dan sesuai dengan
              foto yang diunggah.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question"><span>Berapa komisi yang diambil Teman Singgah?</span>
            <div class="faq-icon"><i class="ph-bold ph-plus"></i></div>
          </button>
          <div class="faq-answer">
            <p>Kami mengambil komisi sebesar 12% dari setiap transaksi yang berhasil. Tidak ada biaya pendaftaran, biaya
              bulanan, atau biaya tersembunyi lainnya.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question"><span>Bagaimana jika tamu merusak properti saya?</span>
            <div class="faq-icon"><i class="ph-bold ph-plus"></i></div>
          </button>
          <div class="faq-answer">
            <p>Setiap pemesanan dilindungi oleh Jaminan Host kami hingga Rp 50 juta untuk kerusakan properti.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question"><span>Kapan saya menerima pembayaran dari tamu?</span>
            <div class="faq-icon"><i class="ph-bold ph-plus"></i></div>
          </button>
          <div class="faq-answer">
            <p>Pembayaran diproses otomatis setiap minggu dan langsung masuk ke rekening bank yang kamu daftarkan.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question"><span>Bisakah saya mendaftarkan lebih dari satu properti?</span>
            <div class="faq-icon"><i class="ph-bold ph-plus"></i></div>
          </button>
          <div class="faq-answer">
            <p>Tentu. Tidak ada batasan jumlah properti yang bisa kamu daftarkan. Banyak host kami mengelola 3–10
              properti sekaligus dari satu akun dashboard.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="invite-section">
      <div class="invite-container">
        <div class="invite-text">
          ...
          <p>Bergabung sekarang dan daftarkan propertimu secara gratis. Proses verifikasi kami cepat — propertimu bisa
            mulai menerima tamu dalam 24 jam.</p>
        </div>
