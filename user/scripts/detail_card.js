...
document.addEventListener("DOMContentLoaded", () => {
  ...
  checkinInput?.addEventListener("focus",  (e) => { e.stopPropagation();
    if (!calendarDropdown.classList.contains("open")) toggleCalendarDropdown(); });
  checkoutInput?.addEventListener("focus", (e) => { e.stopPropagation();
    if (!calendarDropdown.classList.contains("open")) toggleCalendarDropdown(); });
  ...
  guestInput?.addEventListener("focus",  (e) => { e.stopPropagation();
