      ...
      <main class="content-area">
        <div class="filter-container">
          <div class="filter-group" id="filterGroup">
            ...
            <button class="filter-item" data-filter="payout_status:Processing">
              Diproses
            </button>
          ...
          <div class="sort-dropdown">
            <button class="sort-button" data-sort="payout" data-inactive="Urutkan: Jadwal Transfer"
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="action-group">
                      <button class="action-button success" aria-label="Proses" title="Proses">
                ...
                <tr>
                  ...
                  <td>
                    <div class="action-group">
                      ...
                      <button class="action-button success" aria-label="Hapus listing" title="Hapus">
                ...
                <tr>
                  ...
                  <td>
                    <div class="action-group">
                      <button class="action-button success" aria-label="Edit properti" title="Edit">
